...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    ...
    it "shouldn't let a user who didn't create the gram to destroy it" do
  ...
  describe "grams#update action" do
    ...
    it "shouldn't let a user who didn't create the gram to update it" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
      patch :update, params: { id: gram.id, gram: { message: "Yipee!" } }
      expect(response).to have_http_status(:forbidden)
    end
  ...
  describe "grams#edit action" do
    ...
    it "should successfully show the edit form if the gem is found" do
      gram = FactoryBot.create(:gram)
      sign_in gram.user
      get :edit, params: { id: gram.id }
